...
var RoomConditionsMaestro = React.createClass({
    ...
    pushHistory: function(email) {
        history.pushState({}, '', '/room/?email=' + email);
    },
    ...
    render: function() {
        return (<div>
            ...
            <Row><SoundChartWithLabel data={this.state.sound} chartType={this.state.chartType} /></Row>
        </div>)
    }
});

React.renderComponent(<RoomConditionsMaestro />, document.getElementById('room'));
